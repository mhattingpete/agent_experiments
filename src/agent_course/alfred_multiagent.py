...
from smolagents import AgentMemory, AzureOpenAIServerModel, CodeAgent, VisitWebpageTool
...
def check_reasoning_and_plot(final_answer, agent_memory: AgentMemory):
    final_answer
